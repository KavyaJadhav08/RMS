...
if __name__=='__main__':                            
    ...
    window.title('Kavya Jadhav')

    window.geometry('300x300')
    
    tk.Label(window,text=moonlight_rest.rest_name,font=('Helvetica',16)).place(x=10,y=10) 
    tk.Button(window,text='START',command=moonlight_rest.order_process).place(x=10,y=120)
